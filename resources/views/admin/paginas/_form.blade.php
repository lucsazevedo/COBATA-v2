...
@if($pagina->tipo == 'sobre')
	<div class="input-field">
		<input type="text" name="facebook" class="validate" value="{{ isset($pagina->facebook)? $pagina->facebook : '' }}">
		<label>Facebook</label>
	</div>

	<div class="input-field">
		<input type="text" name="instagram" class="validate" value="{{ isset($pagina->instagram)? $pagina->instagram : '' }}">
