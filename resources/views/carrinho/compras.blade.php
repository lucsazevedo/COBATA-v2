                    ...
                    <table>
                        ...
                        @foreach ($pedido->pedido_produtos_itens as $pedido_produto)
                            ...
                            <tr>
                                ...
                                <td>
                                    <img width="100" class="responsive" src="{{ asset($pedido_produto->produto->imagem) }}">
                                </td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="2">
                                    <button type="submit" class="btn-large red col l6 s6 m6 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Cancelar itens selecionados">
                                        Cancelar
                                    </button>

                                    <a href="{{route('carrinho.duplicar', $pedido->id)}}" class="btn-large col l6 s6 m6 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Copiar Pedido para o Carrinho">Copiar</a>   
                                </td>
                                <td colspan="3"></td>
                            </tr>
                        </tfoot>
